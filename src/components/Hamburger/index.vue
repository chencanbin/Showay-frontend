<template>
  <div>
    <!-- <svg fill="#fff" t="1492500959545" class="" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1691" xmlns:xlink="http://www.w3.org/1999/xlink" width="64" height="64">
    ...
    <svg :class="{ 'is-active': isActive }" class="iconfont hamburger" aria-hidden="true" @click="toggleClick">
      <use xlink:href="#icon_top_shouqi"></use>
    </svg>
  </div>
</template>
