      ...
      <el-row 
        ...
        <el-col 
          ...
          <span 
            ...
            style="font-size: 16px; margin-left: 5px">({{ effectiveDate }})</span>
      ...
      <el-dialog 
        ...
        <div 
          ...
          <el-button 
            ...
            type="primary" 
            @click="handlePublish">{{ $t("common.submitButton") }}</el-button>
        </div>
      </el-dialog>
      ...
      <el-dialog 
        ...
        <div 
          ...
          <el-button 
            :loading="buttonLoading" 
            type="primary" 
            @click="handleCloseSetOverrideDialog">{{ $t("common.submitButton") }}</el-button>
        </div>
      </el-dialog>
      <div 
        slot="footer" 
