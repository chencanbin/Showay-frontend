  ...
  <div class="table-container">
    <basic-container>
      ...
      >
        <el-table-column type="expand">
          <template slot-scope="scope">
            <el-form 
              ...
              inline>
              <el-form-item
                :label="$t('product.company.table_header.address')"
              ...
              <el-form-item
                v-for="(item, index) in scope.row.websites"
                :key="index"
                :label="
        ...
        <el-table-column
          :label="$t('product.company.table_header.phone')"
          prop="phone"
          show-overflow-tooltip
        />
        <el-table-column
          :label="$t('product.company.table_header.email')"
          prop="email"
          show-overflow-tooltip
        />
        <el-table-column
