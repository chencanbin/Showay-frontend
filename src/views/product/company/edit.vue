<template>
  <span>
    ...
    <el-dialog v-el-drag-dialog :close-on-click-modal="false" :visible="dialogVisible" :before-close="handleClose" :title="$t('product.company.set.edit_title')" width="620px" append-to-body>
      <el-form ref="company" :model="company" :rules="rule" label-width="120px">
        ...
        <el-button type="primary" circle icon="el-icon-plus" size="mini" class="add_websites" @click="addWebsites" />
