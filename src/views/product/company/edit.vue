  ...
  <span>
    ...
    >
      <el-form 
        ...
        label-width="120px">
        <el-form-item 
          :label="$t('product.company.set.name_en')" 
          prop="en">
          <el-input v-model="company.en" />
        </el-form-item>
        <el-form-item 
          :label="$t('product.company.set.name_zh')" 
          prop="zh">
          <el-input v-model="company.zh" />
        </el-form-item>
        <el-form-item 
          :label="$t('product.company.set.acronym')" 
          prop="acronym">
        ...
        <el-button
          ...
          icon="el-icon-plus"
          size="mini"
          style="position: absolute; top: 408px; left: 12px"
          @click="addWebsites"
        />
        <el-form-item
          v-for="(item, index) in company.websites"
          :key="index"
          :label="'系统地址' + (index + 1)"
        >
          <el-input
            v-model="item.name"
            :class="company.websites.length > 1 ? 'halfWidth' : 'fullWidth'"
          />
          <el-input
            v-model="item.remark"
            style="width: 115px"
          ...
          />
          <el-button
            v-if="company.websites.length > 1"
        ...
        <el-form-item
          :label="$t('product.company.set.contractEffectiveDate')"
        ...
        <el-form-item
          :label="$t('product.company.set.secondary')"
          prop="secondary"
        >
