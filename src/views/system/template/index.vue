              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item>
                  <el-button
                    ...
                    type="text"
                    size="small"
                    @click="handleDelete(scope.row.id)">{{ $t('common.delete') }}
                  </el-button>
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
...
export default {
  ...
  methods: {
    ...
    handleDelete(id) {
      this.$confirm(this.$t('template.tooltip.delete'), this.$t('common.prompt'), {
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            this.$api.template.deleteEmailTemplate(id).then(res => {
              this.$message({
