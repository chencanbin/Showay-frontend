...
export default {
  ...
  data() {
    return {
      ...
      resetLoading: false,
      dialogVisible: false,
      height: this.hasPermission(100081)
  ...
  methods: {
    ...
    handleDeleteChannelHierarchy(id) {
      this.$confirm(
        this.$t("user.tooltip.delete_superior"),
    ...
    handleResetPassword() {
      ...
      this.$api.user
        .resetPassword({ user: this.id, password: sha256(this.password) })
        .then((res) => {
          this.$message({
            message: this.$t("common.success"),
            type: "success",
    ...
    onLockAccount(account) {
      ...
      this.$api.user
        .editUser(account.id, { isLocked: account.isLocked })
        .then((res) => {
          this.$message({
            message: this.$t("common.success"),
            type: "success",
