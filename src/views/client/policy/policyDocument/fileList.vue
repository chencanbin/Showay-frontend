<template>
  <el-dialog id="fileList" :visible="dialogVisible" :before-close="handleClose" :fullscreen="true" :title="title">
    <el-row style="margin-bottom: 5px; padding: 5px">
      <file-upload @afterComplete="afterComplete" />
    </el-row>
    <el-table v-loading="fileLoading" :data="folder.items" :height="tableHeight" stripe>
      ...
      <el-table-column :formatter="dateFormat" label="创建时间" prop="creationDate" width="200px" />
        ...
        <template slot-scope="scope">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>
                <el-button type="text" size="mini" icon="el-icon-download" @click="handleDownload(scope.$index, scope.row)">{{ $t("common.download") }}
                </el-button>
              </el-dropdown-item>
              <el-dropdown-item>
              ...
              <el-dropdown-item>
                <el-button type="text" size="mini" icon="el-icon-delete" @click="handleDelete(scope.$index, scope.row)">{{ $t("common.delete") }}
                </el-button>
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
