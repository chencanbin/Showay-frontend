  ...
  <span id="audit">
    ...
    >
      <el-form 
        ...
        <el-form-item
          v-if="commissionCredit.currency !== 'HKD'"
          :label="$t('commission.credit.calculatedAmountInHkd')"
        >
          {{
      ...
      <div 
        ...
        <el-button 
          ...
          @click="handleReject">{{
            $t("commission.credit.rollback")
          }}</el-button>
        <el-button
          :loading="clearLoading"
          type="primary"
          @click="handleClear"
        >{{ $t("commission.credit.pay") }}</el-button
        >
      </div>
    </el-dialog>
  </span>
...
export default {
  ...
  methods: {
    ...
    handleReject() {
      ...
      this.$api.commission
        .CommissionCreditReject({ ids: [this.commissionCredit.id] })
        .then((_) => {
          this.$message({
    ...
    handleClear() {
      ...
      this.$api.commission
        .CommissionCreditClear({ ids: [this.commissionCredit.id] })
        .then((_) => {
          this.$message({
            message: this.$t("common.success"),
            type: "success",
