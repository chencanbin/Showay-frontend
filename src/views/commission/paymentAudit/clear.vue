  ...
  <span id="clear">
    ...
    >
      <el-form 
        ...
        >
          <el-input
            v-model="clear.chequeNumber"
            :placeholder="$t('commission.payment.set.chequeNumber')"
          />
        </el-form-item>
        <el-form-item
        ...
        >
          <image-upload 
            ref="uploadImage" 
            @afterComplete="setChequeCopy" />
        </el-form-item>
        <el-form-item
          :label="$t('commission.payment.payment_date')"
    ...
    <el-dialog
      ...
      :title="$t('commission.payment.check_detail')"
      top="50px"
      width="400px"
    >
      <el-form>
